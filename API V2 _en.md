...
| side          | Integer    | Yes       | Side：<br/>1 Open long（buy）<br/>2 Open short（sell）<br/>3 Close long（sell）<br />4 Close short（buy) |
...
| side     | No     | Integer  | Side， 0 or empty to query all<br/>1Open long（buy）<br/>2Open short（sell）<br/>3Close long（sell）<br/>4Close short（buy） |
